...
int main()
{
...

    {
        ...
        auto ps = std::make_shared<shak::ParticleSystem>(500, 0.f, 2.f, 3.f, 2.f, 15.f, sf::Vector2(-200.f, -200.f), sf::Vector2f(200.f, 200.f), sf::Color::Blue, sf::Color::Green, nullptr);
